...
class TestExperiment:
    ...
    def test_pick_best_run_with_raw(self):
        ...
        assert os.path.basename(o_exp.best_exp_run.s_run_name) == "run1_with_trailing_0"
    ...
    def test_pick_best_run_with_exp_csv(self):
        ...
        assert len(o_exp.lo_exp_runs) == 2
        assert o_exp.best_exp_run.s_exp_name == s_exp_name
        assert os.path.basename(o_exp.best_exp_run.s_run_name) == "run1"
    ...
    def test_sort_by_total_sample_count(self):
        ...
        assert (
            lo_sorted_runs[0].get_total_sample_count()
            >= lo_sorted_runs[1].get_total_sample_count()
        )
    ...
    def test_process(self):
        ...
        assert os.path.exists(os.path.join(s_dpath, f"{s_exp_name}.parquet"))
